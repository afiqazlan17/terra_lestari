        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('purchases.store') }}" enctype="multipart/form-data"
                    ...
                    <div>
                        <x-input-label for="receipt" value="1. Snap/Upload Resit Dulu" />
    ...
    <script>
        ...
        function showDuplicateWarning(duplicate) {
            ...
            el.textContent = 'Resit ni nampak macam dah pernah direkod: "' + duplicate.description + '"'
                ...
                + '. Kalau ni memang belian berasingan, teruskan simpan seperti biasa.';
        ...
        async function autoFillFromReceipt(input) {
            ...
            try {
                ...
                if (data.supplier_name) {
                    ...
                    // Alpine's x-model only syncs on a real input event, since this
                    // sets .value directly rather than the user typing.
