<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div x-data="posCart({{ $session ? 'true' : 'false' }})" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white shadow-sm rounded-lg p-4 h-fit sticky top-6">
                    ...
                    <form method="POST" :action="'{{ route('pos.store') }}'" @submit="return hasSession && items.length > 0">
                        @csrf
                        ...
                        <button type="submit" :disabled="! hasSession || items.length === 0"
